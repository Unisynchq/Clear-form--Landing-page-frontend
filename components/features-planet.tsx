        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Everything you need to organize and act on feedback
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:-start-px *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:start-0 md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Automatically assess response quality so you know which feedback
                deserves immediate attention and which provides the clearest
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Structured Organization</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Every response is automatically organized into a structured,
                readable format making it easy to scan, compare, and prioritize
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Use intelligent filters to find exactly what you need. Sort by
                quality, sentiment, topic, or custom tags to focus on responses
                that matter most.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Assign responses to team members, add comments, and track
                progress. Keep everyone aligned on handling feedback from a
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Get analytics on your feedback data. Track response patterns,
                identify trends, and understand what your audience really needs
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Action-Oriented Workflow</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Move from responses to decisions without manual cleanup or
                guesswork. Built-in workflows help teams prioritize, discuss,
